...
function AdminDashboard() {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      const totalMembers = groupsRes.data.reduce((sum, g) => sum + (g.allMemberCount || 0), 0)
      const activeMembers = groupsRes.data.reduce((sum, g) => sum + (g.activeMemberCount || 0), 0)
